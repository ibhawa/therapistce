...
The cognitive model proposes that it is not the events in our lives that determine how we feel, but rather the meaning we attach to those events. Distorted or unhelpful thinking patterns drive emotional distress and maladaptive behaviors — and crucially, these patterns can be identified, examined, and changed.`,
      ...
      },
      {
        ...
        resources: [
          ...
          { type: 'tool', title: '7-Column Thought Record (DTR) — Client Worksheet', url: 'resources/thought-record-dtr.pdf', desc: '...' },
          { type: 'tool', title: 'Cognitive Distortions Quick Reference', url: 'resources/cognitive-distortions-reference.pdf', desc: '...' },
          { type: 'tool', title: 'Behavioral Activation Activity Schedule', url: 'resources/behavioral-activation-schedule.pdf', desc: '...' },
        ]
      }
    ]
  },
  {
    ...
    lessons: [
      ...
      { type: 'tool', title: 'MISC 2.0 — MI Skill Code Self-Rating', url: 'resources/mi-skill-code-self-rating.pdf', desc: '...' },
    ]
  },
  {
    id: 'dbt',
    ...
    lessons: [
      ...
      { type: 'tool', title: 'DBT Chain Analysis Form', url: 'resources/dbt-chain-analysis.pdf', desc: '...' },
    ]
  },
  {
    id: 'trauma',
    ...
    lessons: [
      ...
      { type: 'tool', title: 'EMDR Standard Protocol Session Form', url: 'resources/emdr-standard-protocol.pdf', desc: '...' },
    ]
  },
  {
    id: 'act',
    ...
    lessons: [
      ...
      { type: 'tool', title: 'ACT Values Card Sort', url: 'resources/act-values-clarification.pdf', desc: '...' },
    ]
  },
  {
    id: 'family',
    ...
    lessons: [
      ...
      { type: 'tool', title: 'Genogram Construction Template', url: 'resources/genogram-template.pdf', desc: '...' },
    ]
  }
];
